...
def get_path_and_children_dict(heads):
    ...
    return path_dict, children_dict  # 路径，孩子节点
...
def head_to_adj_oneshot(heads, sent_len, aspect_dict,
    ...
    """
    Convert a sequence of head indexes into a 0/1 matirx. Dep.Tree
    """
...
def get_con_adj(father, length, cd_span,
...
def form_aspect_related_spans(aspect_node_idx, spans, mapnode, node2layerid, path_dict,
                              select_N=['ROOT', 'TOP', 'S', 'NP', 'VP'], special_token='[N]'):
